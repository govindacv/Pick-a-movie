    ...
    <div className="description">
      ...
      <div className="desc">
        ...
        <p>
          ...
          recommendation engine is the answer to the question “What movie should
          I watch?”! Your film choices are about to be simplified greatly.
        </p>
        <p>
          ...
          friends or going on a movie date with your crush – our quiz will guide
          you to an awesome choice!
        </p>
        ...
        <ul>
          ...
          <li>
            ...
            Movies, Cop Movies, Heist Movies, Girl Power Movies, Racing Movies,
            Space Movies, Wedding Movies, IMDb Top 250 movies, movies set in New
            York, movies set in Las Vegas, movies that may change the way you
            look at life …
          </li>
        </ul>
      </div>
      <div>
        <h2 className="desc">
          Give it a try! If you like it, please share it! If not, we highly
