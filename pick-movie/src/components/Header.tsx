...
const Header = () => {
  ...
  const [isTopActorDropdownVisible, setTopActorDropdownVisible] =
    useState(false);
  res = false;
  ...
  useEffect(() => {
    axios
      .get(
        `http://www.omdbapi.com/?i=tt3896198&apikey=ac4ecdb3&s=${searchedMovie}`
      )
      .then((response: any) => {
        if (searchedMovie !== "") {
      ...
      <div className="header">
        ...
        <div className="pickAMovie--contents">
          <div className="pickAMovie--moviePicker">
            <Link to={"/q"}>
              <h6>MOVIE PICKER</h6> <div className="verticleArrow">|</div>
            </Link>
          </div>
          ...
          <div
            className="pickAMovie--topactors"
          ...
          <div className="pickAMovie--blog">
            <h6 onClick={handleOnClickBlog}>BLOG</h6>{" "}
            <div className="verticleArrow">|</div>
          </div>
          ...
          <div className="pickAMovie-faceBookLogo">
            <Link to={"https://www.facebook.com/PickAMovieForMeOfficial"}>
              <i className="fa-brands fa-facebook"></i>
            </Link>
          </div>
          <div className="pickAMovie-instagramLogo">
            <Link to={"https://www.instagram.com/pickamovieforme/"}>
              <i className="fa-brands fa-instagram"></i>
            </Link>
          </div>
          <div className="pickAMovie-youtubeLogo">
            <Link
              to={"https://www.youtube.com/channel/UCLLe8pZVF_BWnPp4-TPfsTQ/"}
            >
